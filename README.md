...
- **Q1**) Open the file *data_housing.txt* and take a look at it. You
can also [download](http://archive.ics.uci.edu/ml/datasets/Housing) the
Housing Data Set from the original UCI repository.
